...
useEffect( () =>{
  ...
  if(error) {
    ...
    return(
        ...
        <div className="wrapper my-2" onSubmit={handleSubmit}> 
        <form className="shadow-lg" encType='multipart/form-data'>
            <h1 className="mb-4">New Productcc
            </h1>
            ...
            <div className="form-group">
              ...
              <div className="form-group">
                ...
                <select required onChange={ (e) =>setCategory(e.target.value)} className="form-control" id="category_field">
                ...
                <label>Images</label>
                    ...
                    <div className='custom-file'>
                        <input
                            ...
                            id='customFile'
                            multiple
                            onChange={handleImages} required
                        />
